...
`,closeRender:()=>`</MdDemo>
`})},Ue=async(n,e,s,r=!1)=>{const t=new Set,o=new Set;return e.demo&&(t.add(`import CodeDemo from "${S}components/CodeDemo.js";`),o.add('app.component("CodeDemo", CodeDemo);'),r&&(t.add(`import MdDemo from "${S}components/MdDemo.js";`),o.add('app.component("MdDemo", MdDemo);'))),s.kotlinPlayground&&(t.add(`import KotlinPlayground from "${S}components/KotlinPlayground.js";`),o.add('app.component("KotlinPlayground", KotlinPlayground);')),e.playground&&(t.add(`import Playground from "${S}components/Playground.js";`),o.add('app.component("Playground", Playground);')),s.sandpack&&(t.add(`import SandPack from "${S}components/SandPack.js";`),o.add('app.component("SandPack", SandPack);')),s.vuePlayground&&(t.add(`import VuePlayground from "${S}components/VuePlayground.js";`),o.add('app.component("VuePlayground", VuePlayground);')),n.writeTemp("md-enhance/config.js",`${Array.from(t.values()).join(`
`)}
