...
`;else throw e}return a?.(r,!0)??r},$=async()=>{await import("katex/contrib/mhchem")},E=(t,o={})=>{/* istanbul ignore if -- @preserve */if(!p)throw new Error('[@mdit/plugin-katex-slim]: "katex" is not installed!');const{allowInlineWithSpace:a=!1,delimiters:r,mathFence:e,logger:m=s=>s==="newLineInDisplayMode"?"ignore":"warn",macros:d={},transformer:i,...h}=o;t.use(u,{allowInlineWithSpace:a,delimiters:r,mathFence:e,render:(s,f,w)=>{const c={strict:(k,g,x)=>m(k,g,x,w)??"ignore",macros:d,throwOnError:!1,...h};return f?S(s,c,i):y(s,c,i)}})};export{E as katex,$ as loadMhchem};
