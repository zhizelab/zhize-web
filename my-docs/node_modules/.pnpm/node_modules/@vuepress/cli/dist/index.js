...
import { colors as colors3, logger as logger4, path as path6, picomatch } from "@vuepress/utils";
...
var watchPageFiles = (app) => {
  ...
  const pagesWatcher = chokidar.watch(".", {
    ...
    ignored: (filepath, stats) => {
      ...
      return !!stats?.isFile() && !isPageMatch(path6.relative(sourceDir, filepath));
    },
    ignoreInitial: true
  });
